      ...
      <div className="pointer-events-auto relative flex flex-col items-start gap-1">
        {open ? (
          <div
            ...
            className="mb-1 w-[min(18rem,calc(100vw-1.5rem))] rounded-lg border border-black bg-white p-3 shadow-lg"
          >
        ...
        <button
          ...
          onClick={() => setOpen((o) => !o)}
          title="Calendar type"
          className="flex h-10 w-10 items-center justify-center rounded-full border border-black bg-[#f1f1f1] shadow-md hover:bg-white"
        >
          <svg
            aria-hidden
            width="20"
